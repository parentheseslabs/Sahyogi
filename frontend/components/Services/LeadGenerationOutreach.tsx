...
import {LEAD_GENERATION_OUT_REACH_QUERY} from "../../lib/queries";
...
const LeadGenerationOutreach: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const data = await client.fetch(LEAD_GENERATION_OUT_REACH_QUERY);
...
export default LeadGenerationOutreach; 